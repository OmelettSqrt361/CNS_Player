...
public class LudoDomecek : MonoBehaviour
{
    public List<FigDomecek> player;
    public List<FigDomecek> cmp;
    public int diceMax;
    ...
    public List<int> winningPos = new List<int>();
    ...
    public bool WinCondition()
    {
        ...
        foreach (var pos in player)
        {
            positions.Add(pos.currentPos);
        }
        if (positions.SequenceEqual(winningPos))
        {
    ...
    public void PieceToMove(FigDomecek pieceToMove)
    {
    ...
    string BuildKey(List<FigDomecek> playerPieces, List<FigDomecek> aiPieces, int dice)
    {
        string PositionsToString(List<FigDomecek> pieces)
        {
